        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <c:forEach var="fitnessClient" items="${requestScope.fitnessClients}">
                            <tr>
                                <td>
                                    <c:out value="${fitnessClient.emailAddress}"/>
                                </td>
                                <td>
                                    <c:out value="${fitnessClient.name}"/>
                                </td>
                                <td>
                                    <c:out value="${fitnessClient.phoneNumber}"/>
                                </td>
                                <td>
                                    <c:out value="${fitnessClient.birthDate}"/>
                                </td>
                                <td>
                                    <c:out value="${fitnessClient.gender}"/>
                                </td>
<%--                                <td>
                ...
                <div class="clearfix">
                    ...
                    <ul class="pagination">
                        ...
                        <li class="page-item disabled"><a href="${pageContext.request.contextPath}/navmembers?page=${currentPage - 1}">Previous</a></li>
                        </c:if>
                        ...
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item"><a href="${pageContext.request.contextPath}/navmembers?page=${i}" class="page-link">${i}</a></li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                            <%--Next link--%>
                            <c:if test="${currentPage lt noOfPages}">
                                <li class="page-item disabled"><a href="${pageContext.request.contextPath}/navmembers?page=${currentPage + 1}">Next</a></li>
                            </c:if>
                    </ul>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post">
                    ...
                    <div class="modal-body">
                        <p>Are you sure you want to delete these Fitness Class?</p>
